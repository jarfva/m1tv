...
<table class='table table-bordered'>        
	    ...
	    <tr>
            <td width='200'>No Form Peminjaman </td><td colspan="2"><input readonly type="text" class="form-control" name="no_form_peminjaman" id="no_form_peminjaman" placeholder="No Form Peminjaman" value="<?php echo $no_form; ?>" readonly /></td>
        </tr>
        ...
        <tr><td width='200'>Nama Program </td><td colspan="2"><input readonly type="text" class="form-control" name="nama_program" id="nama_program" placeholder="Nama Program" value="<?php echo $program; ?>" /></td>
           </tr> 

<!--         <tr><td></td><td>
<button type="submit" class="btn btn-danger" onclick='saveKeterangan()'><i class="fa fa-floppy-o"></i> Simpan</button> 
        </td>
	  </tr> -->


        <tr><td></td><td><input type="hidden" name="id_department" value="coba" /> 
...
<!--         <tr><td></td><td><input type="hidden" name="id_department" value="<?php echo $id_department; ?>" /> 
	...
	<div class="box box-warning box-solid">
            ...
            <table class='table table-bordered'>
        <tr><th>Barcode Detail</th><th>Nama Barang</th><th>Keterangan</th><th>Kembali</th></tr>
        <input type="hidden" class="form-control" name="addbarangs" id="addbarangs" value="<?php echo $jumlah?>" />
        <?php foreach ($db as $peminjaman)
            {
                echo "<tr>
                <td>$peminjaman->barcode_barang</td>
                <td>$peminjaman->type_barang</td>
                <td width='200'><input onchange='keterangan()' type='text' class='form-control' name='edit_keterangan' id='edit_keterangan' placeholder='Keterangan' value='$peminjaman->keterangan_barang' />
                </td>
                <td>
                <button type='submit' class='btn btn-info' data-toggle='modal' data-target='#myModal' onclick=simpan('$peminjaman->barcode_barang_detail',$peminjaman->id_barang) )><i class='fa fa-share'></i> Simpan</button>
                </td>
                </tr>" ;
            }
                 ?>
